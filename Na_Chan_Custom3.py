# exec(open('../../Compilations/Kinetics/Na_Chan_Custom3.py').read())
# Na channel parameterized kinetics. Base is experimental kinetics by inf - Colbert Pan 2002. tau - Migliore2018
