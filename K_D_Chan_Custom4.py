# exec(open('../../Compilations/Kinetics/K_D_Chan_Custom3.py').read())
# Random channel. Not based on any exp. Copy of K_A but inactivation gate of Na with mF changed to 0.50
...
l_vhalf_inf, l_slope_inf, l_A, l_B, l_C, l_D, l_E, l_F = -66e-3, -5.3e-3, -0.04560699,0.00433522,0.01197575,0.02617791,0.00853832,0.5
#################################
...
def K_D_Chan(name):
    ...
    ygate = moose.element( K_D.path + '/gateY' )
    ygate.min = Vmin
    ygate.max = Vmax
    ygate.divs = Vdivs
