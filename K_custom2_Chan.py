# exec(open('../../Compilations/Kinetics/K_custom2_Chan_Custom3.py').read())
# K_custom2 channel parameterized kinetics.
...
def K_custom2_Chan(name):
    K_custom2 = moose.HHChannel( '/library/' + name )
    K_custom2.Ek = EK
    K_custom2.Gbar = 300.0*SOMA_A
    K_custom2.Gk = 0.0
    K_custom2.Xpower = 1.0
    K_custom2.Ypower = 1.0
    K_custom2.Zpower = 0
    ...
    xgate = moose.element( K_custom2.path + '/gateX' )
    xgate.min = Vmin
    xgate.max = Vmax
    xgate.divs = Vdivs
    ...
    ygate = moose.element( K_custom2.path + '/gateY' )
    ygate.min = Vmin
    ygate.max = Vmax
    ygate.divs = Vdivs
